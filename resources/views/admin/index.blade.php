                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap14">
                            ...
                            <div>
                                ...
                                <h4>${{ number_format($dashboard->TotalAmount ?? 0, 2) }}</h4>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap14">
                            ...
                            <div>
                                ...
                                <h4>${{ number_format($dashboard->TotalOrderedAmount ?? 0, 2) }}</h4>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap14">
                            ...
                            <div>
                                ...
                                <h4>${{ number_format($dashboard->TotalDeliveredAmount ?? 0, 2) }}</h4>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap14">
                            ...
                            <div>
                                ...
                                <h4>${{ number_format($dashboard->TotalCanceledAmount ?? 0, 2) }}</h4>
                            </div>
                        </div>
                    </div>
                </div>
