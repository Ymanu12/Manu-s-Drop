          ...
          <table class="cart-table">
            ...
            @foreach($items as $item)
              <tr>
                ...
                <td>
                <form method="POST" action="{{ route('cart.item.remove', ['rowId' => $item->rowId]) }}" class="remove-cart-form">
                    @csrf
                    @method('DELETE')
                    <button type="submit" class="remove-cart" style="border: none; background: none; padding: 0; cursor: pointer;">
