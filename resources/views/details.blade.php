              ...
              <div class="swiper-container">
                ...
                @if(!empty($product->images_list))
                    @foreach($product->images_list as $img)
                        <div class="swiper-slide product-single__image-item">
                            <img loading="lazy" class="h-auto" src="{{ asset('uploads/products/' . trim($img)) }}" width="674"
                            height="674" alt="" />
                            <a data-fancybox="gallery" href="{{ asset('uploads/products/' . trim($img)) }}" data-bs-toggle="tooltip"
                            data-bs-placement="left" title="Zoom">
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <use href="#icon_zoom" />
                            </svg>
                ...
                <div class="swiper-wrapper">
                  <div class="swiper-slide product-single__image-item"><img loading="lazy" class="h-auto"
                    ...
                    @if(!empty($product->images_list))
                        ...
                        <div class="swiper-slide product-single__image-item"><img loading="lazy" class="h-auto"
                            src="{{ asset('uploads/products/thumbnails/' . trim($img)) }}" width="104" height="104" alt="" /></div>
                        @endforeach
                    @endif
                </div>
              </div>
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide product-card">
              <div class="pc__img-wrapper">
                <a href="{{route('shop.product.detail', ['product_slug' => $product->slug])}}">
                  <img loading="lazy" src="{{ asset('uploads/products/thumbnails/' . $product->image) }}" width="330" height="400"
                    alt="{{$product->name}}" class="pc__img">

                    @if(!empty($product->images_list))
                        @foreach($product->images_list as $img)
                        <img loading="lazy" src="{{ asset('uploads/products/thumbnails/' . trim($img)) }}" width="330" height="400"
